...
},{"./components/assets/listing/listing":22,"./components/assets/modals/folder-editor":24,"./components/dossier/dossier":28,"./components/forms/form":32,"./components/modal/modal":40,"./core/bootstrap":42,"./fieldtypes/assets/browser/browser":48,"./fieldtypes/avatar/avatar":50,"./plugins/resource_url":56}],19:[function(require,module,exports){
'use strict';
...
},{"./app.globals":18,"./components/assets/browser/browser":20,"./components/common/errors":26,"./components/common/messages":27,"./components/forms/business_category":31,"./components/forms/user":33,"./components/forms/video":34,"./components/forms/video_category":35,"./components/listings/business_categories":36,"./components/listings/users":37,"./components/listings/video_categories":38,"./components/listings/videos":39}],20:[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	data: function data() {
		return {
			...
			ajax: {
				method: 'store',
				store: cp_url('business/categories'),
				update: cp_url('business/categories/update')
			}
		};
	},
	...
	ready: function ready() {
		...
		this.whenReady(function (data) {
			...
			if (data.category !== null) {
				self.ajax.update = cp_url('business/categories/' + data.category.id);
			}
			return true;
		});
	},
	...
	components: {
		...
		'user-categories': {
			...
			computed: {
				...
				hasUserCategories: function hasUserCategories() {
...
},{"./../../fieldtypes/select2/select2":52,"./../../fieldtypes/toggle/toggle":54}],35:[function(require,module,exports){
'use strict';
...
},{"./modal.template.html":41}],41:[function(require,module,exports){
...
},{"./../cp.js":47,"./../theme/theme":57,"./forms/bootstrap":43,"bootstrap-sass/assets/javascripts/bootstrap":3,"jquery":4,"promise":6,"select2/dist/js/select2.full.min.js":14,"underscore":15,"vue":17,"vue-resource":16}],43:[function(require,module,exports){
'use strict';
...
},{"./errors":44,"./http":45,"./instances":46}],44:[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	store: function store(uri, form) {
		return App.post(uri, form);
	},

	update: function update(uri, form) {
...
},{"./browser.template.html":49}],49:[function(require,module,exports){
...
module.exports = {
	...
	computed: {
		...
		photoAvatar: function photoAvatar() {
			if (this.profile != '') {
...
},{"./avatar.template.html":51}],51:[function(require,module,exports){
module.exports = '<div class="avatar_wrapper" :class="{\'loading\':loading}">\n	<a href="" @click.prevent="changeAvatar">\n		<div class="thumb">\n			<img class="avatar" :src="photoAvatar">\n			 <div v-if="loading" class="loading">\n		        <span class="icon icon-circular-graph animation-spin"></span> Loading..\n		    </div>\n		</div>\n	</a>\n\n	<input type="file"\n	   :name="name"\n	   :id="id"\n	   class="avatar-upload hide"\n	   @change="file"\n	   v-el:avatar\n/>\n</div>\n';
...
},{"./select2.template.html":53}],53:[function(require,module,exports){
...
},{"./toggle.template.html":55}],55:[function(require,module,exports){
...
if (_typeof(window.$) === undefined || _typeof(window.jQuery) === undefined) {
				...
				nextElement.slideDown(animationSpeed, function () {
					...
					if (activeMenuUL !== null || activeMenuUL !== undefined) {
						activeMenuUL.slideUp(function () {
							activeMenuUL.removeClass('nav_open').css('display', 'none');
						});
					}
